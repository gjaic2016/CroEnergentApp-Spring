...
public class MostIndefiniteContractsPerHouseholdController {
    ...
    private MostIndefiniteContractsPerHouseholdImpl mostIndefiniteContractsPerHouseholdImpl;

    @GetMapping
    public ResponseEntity<?> getMostIndefiniteContractsPerHousehold(){
        return ResponseEntity.status(HttpStatus.OK)
                .body(mostIndefiniteContractsPerHouseholdImpl.getMostIndefiniteContractsPerHousehold());
    }
